...
function previewFive() {
   ...
   articleEI.insertBefore(firstFigure, document.getElementByld("fig2"));
...
function createEventListeners() {
    ...
    //declare variables for document element with id of rightarrow, which is in the html document 
